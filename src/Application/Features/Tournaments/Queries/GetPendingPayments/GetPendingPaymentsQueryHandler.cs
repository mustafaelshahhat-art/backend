...
public class GetPendingPaymentsQueryHandler : IRequestHandler<GetPendingPaymentsQuery, PagedResult<PendingPaymentResponse>>
{
    private readonly IRepository<TeamRegistration> _registrationRepository;

    public GetPendingPaymentsQueryHandler(IRepository<TeamRegistration> registrationRepository)
    {
        _registrationRepository = registrationRepository;
    }

    public async Task<PagedResult<PendingPaymentResponse>> Handle(GetPendingPaymentsQuery request, CancellationToken ct)
    {
